...
class Queue:
    ...
    def remove_max(self):
        ...
        while current != None and current.cargo != Queue.max_value(self):
            previous = current
...
def selectionSort(unsorted_linked_list):
    ...
    if unsorted_linked_list.length <= 1: 
        ...
        sorted_list = Queue()
        max_element = unsorted_linked_list.max_value()
        sorted_list.append(max_element)
        unsorted_linked_list.remove_max() 
        
        
    sorted_list.concatenate(selectionSort(unsorted_linked_list))
    return sorted_list   