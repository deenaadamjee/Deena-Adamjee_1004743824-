...
def damped_oscillator_position(gamma, t, omega_0):
    ...
    angular frenquency (omega_0), it produces the position of the oscillator
    at the given time.
    

    >>> position = damped_oscillator_position(gamma, t, omega_0)
    >>> position = 
    -0.7798529395484154
    """
    position = math.e**(-1*gamma*t)*math.cos(math.sqrt(omega_0**2 - gamma**2)*t)
    return position
